    ...
    <div className="limiter">
      <div className="container-login100">
        <div className="wrap-login100">
          ...
          <form className="login100-form validate-form needs-validation" onSubmit={handleSubmit}>
            ...
            <div style={{ height: 15 }}>
              <span>{invalidEmail && email !== '' ? <p class="text-danger text-center">Invalid Email !</p> : null}</span>
            </div>
            <div className="container-login100-form-btn">
              {invalidEmail || invalidPwd || email === '' || password === '' ? <button className="login100-form-btn btn-secondary" type="submit" disabled>
                {loader && <span className="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>}
              Login
            </button> : <button className="login100-form-btn" type="submit">
                  {loader && <span className="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>}
              Login
            </button>}
            </div>
